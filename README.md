...
| 预览版  | [![Preview v0.5.8-beta.2](https://img.shields.io/badge/Preview-v0.5.8--beta.2-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.2)                                                                                                                                                                                                                                                | 当前预览版：`v0.5.8-beta.2`。也可在应用内「设置 → 关于」打开「预览版通道」后自动检查并升级                                                                                                                                                                                                                                                                                                                                                                        |
...
- Skill 生命周期、项目/Agent 管理和平台安装/卸载链路继续加固
- Skill 管理切换动画统一为横向过渡，项目删除按钮改为 destructive 样式
