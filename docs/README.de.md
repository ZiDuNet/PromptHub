...
| Vorschau  | [![Preview v0.5.8-beta.2](https://img.shields.io/badge/Preview-v0.5.8--beta.2-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.2) | Aktuelle Vorschau: `v0.5.8-beta.2`. Alternativ den Vorschau-Kanal unter *Einstellungen → Über* aktivieren, damit die App automatisch prüft und aktualisiert. |
...
### v0.5.8-beta.2 ← letzte Vorschau

- Skill-Lifecycle, Projekt-/Agent-Verwaltung und Plattform-Installations-/Deinstallationspfade wurden weiter gehärtet
- Skill-Management-Wechsel nutzen jetzt horizontale Übergänge; die Projekt-Löschaktion nutzt destructive Styling
