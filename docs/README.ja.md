...
| プレビュー       | [![Preview v0.5.8-beta.3](https://img.shields.io/badge/Preview-v0.5.8--beta.3-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.3) | 現在のプレビュー版は `v0.5.8-beta.3` です。必要なら「設定 → このアプリについて」でプレビューチャンネルを有効化して自動チェックと更新も使えます。 |
...
### v0.5.8-beta.3 ← 最近のプレビュー版

- Skill ソース編集、ファイルアイコン、シンタックスハイライトを補完
- GitHub ソースの Skill は My Skills 詳細から更新確認と適用が可能
- Skill ライフサイクルマトリクス、Prompt / Skill バージョン履歴、起動ログノイズをさらに整理
