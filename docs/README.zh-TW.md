...
| 預覽版  | [![Preview v0.5.8-beta.3](https://img.shields.io/badge/Preview-v0.5.8--beta.3-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.3) | 目前預覽版：`v0.5.8-beta.3`。也可在應用內「設定 → 關於」打開「預覽版通道」後自動檢查並升級 |
...
- Skill 源碼編輯器、檔案圖示與語法高亮體驗補齊
- GitHub 來源 Skill 可在「我的 Skill」詳情頁檢查並套用來源更新
- Skill 生命週期矩陣、Prompt / Skill 版本歷史與啟動日誌噪聲繼續收口
