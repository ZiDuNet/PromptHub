...
| 預覽版  | [![Preview v0.5.8-beta.2](https://img.shields.io/badge/Preview-v0.5.8--beta.2-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.2) | 目前預覽版：`v0.5.8-beta.2`。也可在應用內「設定 → 關於」打開「預覽版通道」後自動檢查並升級 |
...
- Skill 生命週期、專案 / Agent 管理與平台安裝 / 解除安裝鏈路繼續加固
- Skill 管理切換動畫統一為橫向過渡，專案刪除按鈕改為 destructive 樣式
